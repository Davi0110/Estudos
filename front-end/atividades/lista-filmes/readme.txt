Você recebeu a tarefa de criar uma aplicação para listar seus filmes favoritos, seu objetivo é capturar os valores que são digitados no campo de input e ao clicar no botão adicionar eles na tela.
